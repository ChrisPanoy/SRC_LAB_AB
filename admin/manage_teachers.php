    ...
    <div class="modal-content">
        ...
        <form method="POST" class="edit-form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="reset_teacher_name" name="teacher_name" readonly class="bg-gray-100">
                <small class="form-help">This teacher's password will be reset</small>
            </div>
            ...
            <div class="form-group">
                ...
                <small class="form-help">Password must be at least 8 characters long and contain at least one special character</small>
            </div>

            <div class="form-group">
                <label for="reset_confirm_password">Confirm New Password *</label>
                <input type="password" id="reset_confirm_password" name="reset_confirm_password" required placeholder="Confirm new password">
                <small class="form-help">Please re-enter the new password</small>
            </div>

            <div class="form-actions">
                <button type="submit" class="btn-primary" onclick="return validatePasswordReset()">Reset Password</button>
